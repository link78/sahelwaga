...
- Production SSH access to the Ubuntu host (API + web systemd services, nginx)
...
| [ubuntu.md](./ubuntu.md) | Deploy the API + web + Postgres to an Ubuntu host (systemd + nginx) |
